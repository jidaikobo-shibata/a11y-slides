...
<p><a style="color:#fff !important;" href="<?php echo build_slide_url('./person.php', 'sr', $theme); ?>">（スクリーンリーダ用に切り替え）</a></p>
<?php else: ?>
<h2 style="margin: 0;">スクリーンリーダ用について</h2>
<ul>
	<li>スライドの仕様上、h1（見出し1）が多い構造になっています。</li>
</ul>
<p><a style="color:#fff !important;" href="<?php echo build_slide_url('./person.php', null, $theme); ?>">（スライド用に切り替え）</a></p>
<?php endif; ?>
</small>
</h1>
</div>
